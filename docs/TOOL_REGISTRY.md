...
- Responsibilities should match one of the command responsibility labels listed
  in this document, such as `Verification`, `Task state`, `Tool access`,
  `Project memory`, `Observability`, `Context selection`, `Entropy auditing`,
  `Intervention recording`, or `Failure attribution`.
