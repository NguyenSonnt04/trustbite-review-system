...
| Mobile map | MapLibre/AWS Location map-first view with floating search and a snapping nearby-results sheet; consumes visible viewport bounds and backend-normalized place/route DTOs | Complete nearby-marker, place-selection, and route-line interaction smoke before release claim |
