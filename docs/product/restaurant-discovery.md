...
| Mobile map | MapLibre/AWS Location map-first view with Vietnamese floating search, compact snapping sheet, trust-score markers, selected restaurant actions, and fitted route geometry; consumes visible viewport bounds and backend-normalized place/route DTOs | Complete redesigned marker/card, place-selection, and route-line interaction smoke with nearby fixture data before release claim |
